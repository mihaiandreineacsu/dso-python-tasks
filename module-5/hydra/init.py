...
def init() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        required=True,
        type=str,
        help="Server as IP-Address or DNS name to connect",
    )
    parser.add_argument(
        "-p",
        "--port",
    ...
    parser.add_argument(
        ...
        required=False,
        type=str,
        help="Word list file used as dictionary",
    )
    parser.add_argument(
        "-c",
        "--characterset",
        ...
        type=str,
        default="[a-z]",
        help="Basic characters set used to generate a list of words. Default is [a-z]",
    )
    parser.add_argument(
        "--min",
        required=False,
        type=int,
        default=3,
        help="Minimal generated word length. Default is 3",
    )
    parser.add_argument(
        "--max",
        required=False,
        type=int,
        default=3,
        help="Maximal generated word length. Default is 3",
    )
