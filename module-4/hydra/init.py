...
def init()-> argparse.Namespace:
    ...
    Usage examples:
        Using wordlist: $python hydra.py -u mihaiandrei -s 127.0.0.1 -w dictionary.txt
        Using characterset: $python hydra.py -u mihaiandrei -s 127.0.0.1 -c [a-ZA-z0-9] --min 3 --max 4
    """
